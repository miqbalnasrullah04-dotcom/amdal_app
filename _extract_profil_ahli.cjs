  ...
  for await (const line of rl) {
    if (line.includes('view_file')) {
      try {
        ...
        if (obj.type === 'ENVIRONMENT_RESPONSE' && obj.content) {
             const parsed = JSON.parse(obj.content);
             if (parsed.output && parsed.output.includes('file:///c:/laragon/www/TenagaAhli/TenagaAhli/frontend/src/pages/ProfilAhli.jsx')) {
