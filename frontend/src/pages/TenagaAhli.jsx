...
export default function TenagaAhli() {
  ...
  const [kriteria, setKriteria] = useState(
    searchParams.get('kategori') || searchParams.get('kriteria') || 'Tenaga Ahli'
  );
    ...
    api
      .get('/experts', {
        params: {
          ...
          kriteria: searchParams.get('kategori') || searchParams.get('kriteria') || 'Tenaga Ahli',
              ...
              sortedExperts.map((expert, index) => (
                ...
                >
                  ...
                  {expert.slug && (
                    ...
                    >
                      {t('experts.view_profile', 'Lihat Profil')}
                    </Link>
                  )}
