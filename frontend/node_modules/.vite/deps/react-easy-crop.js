...
//#region node_modules/normalize-wheel/src/UserAgent_DEPRECATED.js
...
//#endregion
//#region node_modules/normalize-wheel/src/ExecutionEnvironment.js
/**
...
//#endregion
//#region node_modules/normalize-wheel/src/isEventSupported.js
/**
...
//#endregion
//#region node_modules/normalize-wheel/src/normalizeWheel.js
/**
* Copyright (c) 2015, Facebook, Inc.
* All rights reserved.
*
...
//#endregion
//#region node_modules/normalize-wheel/index.js
var require_normalize_wheel = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = require_normalizeWheel();
}));
//#endregion
//#region node_modules/react-easy-crop/index.module.mjs
var import_react = /* @__PURE__ */ __toESM(require_react(), 1);
var import_normalize_wheel = /* @__PURE__ */ __toESM(require_normalize_wheel(), 1);
function _typeof(o) {
...
var MAX_ZOOM = 3;
var KEYBOARD_STEP = 1;
var Cropper = class Cropper extends import_react.Component {
	constructor(..._args) {
		super(..._args);
		this.cropperRef = import_react.createRef();
		this.imageRef = import_react.createRef();
		this.videoRef = import_react.createRef();
	...
	render() {
		...
		return /* @__PURE__ */ import_react.createElement("div", {
		...
		}, image ? /* @__PURE__ */ import_react.createElement("img", _objectSpread2(_objectSpread2({
			alt: "",
		...
		})) : video && /* @__PURE__ */ import_react.createElement("video", _objectSpread2(_objectSpread2({
			autoPlay: true,
			playsInline: true,
			loop: true,
			muted: true,
			...
			style: _objectSpread2(_objectSpread2({}, mediaStyle), {}, { transform: transform || `translate(${x}px, ${y}px) rotate(${rotation}deg) scale(${zoom})` }),
			controls: false
		}), (Array.isArray(video) ? video : [{ src: video }]).map((item) => /* @__PURE__ */ import_react.createElement("source", _objectSpread2({ key: item.src }, item)))), this.state.cropSize && /* @__PURE__ */ import_react.createElement("div", _objectSpread2({
			ref: this.cropperRef,
